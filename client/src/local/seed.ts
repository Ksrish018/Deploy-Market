// Ported from server/src/seed.js — identical logic, running in the browser
// instead of Node, for the offline single-file build.
import { id } from './id';
import type { Cycle, ContextPriority, WeightProfile, OwnerMapEntry } from '../types';
...
export interface AppState {
  ...
  ownerMap: OwnerMapEntry[];
  tasks: import('../types').Task[];
  approvals: import('../types').Approval[];
  briefs: import('../types').Brief[];
  runLogs: import('../types').RunLog[];
  auditLog: import('../types').AuditEntry[];
}
...
export function defaultOwnerMap(): OwnerMapEntry[] {
  return [
